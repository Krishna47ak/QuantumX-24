...
const FilterDropdown = ({ data, setFilterData, filterData, name, width, style }) => {
    ...
    return (
        <div className="relative w-40" >
            ...
            <ul className={`${onFilter ? 'list-item' : 'hidden'} absolute divide-y-2 divide-[#00000033] bg-gray-800 w-full shadow-xl border border-[#00000033] rounded-b-lg text-center px-2 py-1`} >
                {data?.map((value) => (
