...
const CountdownTimer = () => {
  ...
  return (
    <div>
      <div className="bg-gradient-to-b from-black to-[#831c84] flex justify-center items-center p-10 py-20 text-4xl font-bold text-white text-center space-x-10">
        <div className="flex flex-col space-y-5" id="daysCol">
          <p className="font-medium">DAYS</p>
          <span className="text-5xl">{isDays}</span>
        </div>
        <p className="mt-auto">:</p>
        <div className="flex flex-col space-y-5" id="hoursCol">
          <p className="font-medium">HOURS</p>
          <span className="text-5xl">{isHours}</span>
        </div>
        <p className="mt-auto">:</p>
        <div className="flex flex-col space-y-5" id="minsCol">
          <p className="font-medium">MINS</p>
          <span className="text-5xl">{isMins}</span>
        </div>
        <p className="mt-auto">:</p>
        <div className="flex flex-col space-y-5" id="secondsCol">
          <p className="font-medium">SECS</p>
          <span className="text-5xl">{isSecs}</span>
        </div>
      </div>
    </div>
  );
