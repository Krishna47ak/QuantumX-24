...
const Landing = () => {
    return (
        <div className='p-10 flex items-center justify-between h-[91vh] overflow-hidden' >
            ...
            <div className='relative bg-black h-[40rem] w-[40rem] p-5 rounded-full bg-opacity-60 flex flex-col items-center' >
                <p className='text-xl z-10 text-white font-semibold text-center mt-[30%] landingText' >
