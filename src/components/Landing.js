...
const Landing = () => {
    ...
    return (
        <div className="bg-[url('/home-bg.jpg')] bg-[center_top_0px] bg-cover bg-fixed flex justify-center items-end p-10 min-h-screen overflow-hidden" >
            ...
            {onVideo && (
                <div className="fixed flex justify-center items-center pt-[9vh] z-20 bg-[#0000004d] backdrop-blur-sm top-0 bottom-0 left-0 right-0" >
            ...
            <div onClick={() => setOnVideo(true)} className='relative bg-black rounded-full ml-14 mb-5 cursor-pointer' >
