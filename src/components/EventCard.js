                ...
                <div className='fixed flex justify-center items-center py-32 z-20 bg-[#0000004d] top-0 bottom-0 left-0 right-0' >
                    ...
                    <div onMouseLeave={() => setOnCard(false)} className='relative flex min-[1293px]:space-x-5 bg-[#0f172ad9] backdrop-blur-md w-[85vw] h-[30rem] md:h-[35rem] mt-16 rounded-3xl md:px-10 py-7 pt-10 md:py-12 lg:py-16' >
                        ...
                        <div className='flex flex-col justify-between py-1 overflow-x-auto px-7 md:px-0' >
                            ...
                            {((data?.id != "QX_EV_04") && (data?.id != "QX_EV_05") && (data?.id != "QX_EV_06") && (data?.id != "QX_EV_07") && (data?.id != "QX_EV_14") && (data?.id != "QX_EV_12") && (data?.id != "QX_EV_02") && (data?.id != "QX_EV_03") && (data?.id != "QX_EV_20") && (data?.id != "QX_EV_10") && (data?.id != "QX_EV_09") && (data?.id != "QX_EV_16") && (data?.id != "QX_EV_13") && (data?.id != "QX_EV_18") && (data?.id != "QX_EV_21") && (data?.id != "QX_WS_26") && (data?.id != "QX_WS_09") && (data?.id != "QX_WS_21") && (data?.id != "QX_WS_15") && (data?.id != "QX_WS_17") && (data?.id != "QX_WS_19") && (data?.id != "QX_WS_02") && (data?.id != "QX_WS_04") && (data?.id != "QX_WS_06") && (data?.id != "QX_WS_16") && (data?.id != "QX_WS_18") && (data?.id != "QX_WS_20") && (data?.id != "QX_WS_25") && (data?.id != "QX_WS_28")) && (
