                    ...
                    <div onMouseLeave={() => setOnCard(false)} className='relative flex min-[1293px]:space-x-5 bg-[#0f172ad9] backdrop-blur-md w-[85vw] h-[30rem] md:h-[35rem] mt-16 rounded-3xl md:px-10 py-7 pt-10 md:py-12 lg:py-16' >
                        ...
                        <div className='flex flex-col justify-between py-1 overflow-x-auto px-7 md:px-0' >
                            <div>
                                ...
                                {((data?.id === "QX_EV_08") || (data?.id === "QX_EV_09") || (data?.id === "QX_EV_10") || (data?.id === "QX_EV_11")) && (
                                    <div className='text-yellow-400 text-sm mt-2' >*Only for school students</div>
                                )}
                            </div>
                            {((data?.id != "QX_EV_04") && (data?.id != "QX_EV_05") && (data?.id != "QX_EV_06") && (data?.id != "QX_EV_07") && (data?.id != "QX_EV_14") && (data?.id != "QX_EV_12") && (data?.id != "QX_EV_02") && (data?.id != "QX_EV_20") && (data?.id != "QX_EV_10") && (data?.id != "QX_EV_09") && (data?.id != "QX_EV_16") && (data?.id != "QX_EV_13") && (data?.id != "QX_EV_18") && (data?.id != "QX_EV_21") && (data?.id != "QX_EV_19") && (data?.id != "QX_WS_26") && (data?.id != "QX_WS_09") && (data?.id != "QX_WS_21") && (data?.id != "QX_WS_15") && (data?.id != "QX_WS_17") && (data?.id != "QX_WS_19") && (data?.id != "QX_WS_02") && (data?.id != "QX_WS_04") && (data?.id != "QX_WS_06") && (data?.id != "QX_WS_16") && (data?.id != "QX_WS_18") && (data?.id != "QX_WS_20") && (data?.id != "QX_WS_25") && (data?.id != "QX_WS_28") && (data?.id != "QX_WS_13")) && (
